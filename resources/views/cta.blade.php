        ...
        <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-8 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none flex flex-col items-center justify-center text-center">
            ...
            <ul class="flex flex-col gap-6 mb-8 max-w-md">
                <li class="space-y-2">
                    ...
                    <p class="text-[#706f6c] dark:text-[#A1A09A] italic">"Do not be anxious about anything, but in every situation, by prayer and petition, with thanksgiving, present your requests to God."</p>
                </li>
                <li class="space-y-2">
                    <p class="font-medium text-[#f53003] dark:text-[#FF4433] italic">1 Thessalonians 5:17</p>
                    <p class="text-[#706f6c] dark:text-[#A1A09A]">"Pray without ceasing."</p>
                </li>
                <li class="space-y-2">
                    <p class="font-medium text-[#f53003] dark:text-[#FF4433] italic">Matthew 6:6</p>
            ...
            <ul class="flex flex-col gap-6 mb-6 max-w-md">
                <li class="space-y-2">
            ...
            <ul class="flex gap-3 text-sm leading-normal">
                <li>
                    <x-guest-button href="{{ route('callbacks.request') }}">
                        Request Callback
                    </x-guest-button>
                </li>
                <li>
                    <x-guest-button href="{{ route('prayers.create') }}">
                        Submit Prayer
                    </x-guest-button>
                </li>
            </ul>
            ...
            <div class="mt-4">
                <x-guest-button href="{{ route('testimonials.share') }}">
